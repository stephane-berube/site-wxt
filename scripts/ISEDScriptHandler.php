...
<IfModule mod_headers.c>
  ...
  # CSP
  Header always set Content-Security-Policy "default-src 'none'; font-src 'self' https://fonts.gstatic.com; img-src https://jira.ised-isde.canada.ca 'self'; script-src 'self' 'unsafe-inline' https://jira.ised-isde.canada.ca; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; connect-src 'self'; object-src 'self'; frame-src https://sso-dev.ised-isde.canada.ca https://jira.ised-isde.canada.ca 'self'; frame-ancestors 'self'; base-uri 'self'; form-action 'self'"
</IfModule>
